...
public static class JsonhNumberParserBig {
    ...
    /// </summary>
    private static Result<BigReal> ParseFractionalNumberWithExponent(scoped ReadOnlySpan<char> Digits, scoped ReadOnlySpan<char> BaseDigits, int Decimals) {
        // Find exponent
        int ExponentIndex = -1;
    ...
    /// </summary>
    private static Result<BigReal> ParseFractionalNumber(scoped ReadOnlySpan<char> Digits, scoped ReadOnlySpan<char> BaseDigits) {
    ...
    /// </summary>
    private static Result<BigInteger> ParseWholeNumber(scoped ReadOnlySpan<char> Digits, scoped ReadOnlySpan<char> BaseDigits) {
        // Optimization for base-10 digits
        if (BaseDigits is "0123456789") {
            try {
